...
@section('title', 'Tambah Sekolah - ProPePa')
@section('header_title', 'Tambah Sekolah Baru')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-[2rem] border border-outline-variant/30 shadow-sm overflow-hidden">
        ...
        <form action="{{ route('admin.schools.store') }}" method="POST" class="p-8 space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" required
                       ...
                       placeholder="Contoh: SD Negeri 1 Mulyaharja">
            ...
            <div>
                ...
                <textarea id="address" name="address" rows="3"
                          class="w-full rounded-xl border border-outline-variant/50 focus:border-primary focus:ring-0 px-4 py-3 bg-surface-container-lowest">{{ old('address') }}</textarea>
