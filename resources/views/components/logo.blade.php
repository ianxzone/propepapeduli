...
@php
    $logo = $site_settings['site_logo'] ?? 'https://lh3.googleusercontent.com/aida-public/AB6AXuCNPPLLCXI_weBqrbq0jVwVfujoLheHHc-JGI7oQFPRdxrRL8NS-vCO2kBp-VxNO5mcYfHrn6wl3cjPQE38WMsKx581Gzw3WWPCtIR2JxQlGfLLDjs4pu29DmMM8SKx4by8kX74VEb2iUzYMeqBdtDedT-yQ_GhxHAM-AcbjtiKZ8UBGQMl-ya5cHUuYwOGK0JjXJF6laJC3KNQ_uU-u7lAf2d9_5ZhmNXWqBf7Wzq9MeTB7V5nOYXiYv6EjSUOdcpcvIRnOmZ5dY3O';
    ...
    <div class="flex items-center">
        <div class="flex items-center bg-primary rounded-full pr-6 pl-1 py-1 shadow-sm border border-primary/20">
            <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center p-1.5 shadow-inner">
                <img src="{{ $logo }}" 
                     alt="{{ $name }}" class="w-full h-auto {{ str_contains($logo, 'googleusercontent') ? 'brightness-0 saturate-100 invert-[25%] sepia-[100%] saturate-[5000%] hue-rotate-[350deg] brightness-[40%] contrast-[110%]' : '' }}">
            </div>
...
@else
    <div class="flex items-center gap-4">
        <div class="w-14 h-14 flex items-center justify-center">
             <img src="{{ $logo }}" 
                  alt="{{ $name }}" class="w-full h-auto {{ str_contains($logo, 'googleusercontent') ? 'brightness-0 saturate-100 invert-[15%] sepia-[95%] saturate-[6932%] hue-rotate-[358deg] brightness-[35%] contrast-[107%]' : '' }}">
        </div>
